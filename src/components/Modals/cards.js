    ...
    useEffect(()=>{
        const getData = async ()=>{
            ...
            //   setTodos(characters.data);
                ...
                const data = await fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${finded}&ts=1&apikey=658e18f8683906f0d0b8faf4bc7cf703&hash=${hash}`
                )
                const characters = await data.json();
               // console.log(characters);compruebo que la informacion traída del fetch se guarde en characters
